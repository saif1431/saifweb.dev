...
export const PROJECTS = [
  ...
  {
    id: "medicine-recommendation-agent",
    title: "Medicine Recommendation Agent",
    description:
      "An LLM-powered agent that recommends medicines based on user-described symptoms, built with LangChain and the Mistral API.",
    longDescription:
      "Built an AI agent using LangChain orchestration on top of the Mistral API to recommend medicines from user-described symptoms. The agent interprets natural-language symptom input and reasons through it to surface relevant medicine suggestions, rather than relying on rigid keyword matching.",
    tech: ["LangChain", "Mistral API", "Python"],
    category: "AI/ML",
    featured: false,
    github: null,
    demo: null,
    video: "/projects/medicine-recommendation-agent.mp4",
    image: null,
    gradient: "from-teal-600/40 to-emerald-900/60",
  },
  {
    ...
    github: null,
    demo: null,
    video: "/projects/ericsson-5g-quest-map.mp4",
  ...
  },
  {
    ...
    github: null,
    demo: null,
    video: "/projects/chat-application.mp4",
    image: null,
  ...
  },
  {
    ...
    github: null,
    demo: null,
    video: "/projects/graph-charts.mp4",
    image: null,
